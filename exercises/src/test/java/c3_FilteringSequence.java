...
public class c3_FilteringSequence extends FilteringSequenceBase {
    ...
    /**
     * `mashed_data_service()` returns sequence of generic objects. Without using `filter()` operator, collect only
     * objects that are instance of `String`
     */
    @Test
    ...
    /**
     * This service returns many elements, but you are only interested in the first one. Also, service is very fragile,
     * if you pull more than needed, you may break it.
     * <p>
